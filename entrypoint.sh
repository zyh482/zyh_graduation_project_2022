...
SAVEDIR=checkpoints/iwed_${src}_${tgt}_${bedropout}_finetune_bert
mkdir -p $SAVEDIR
...
-a $ARCH --optimizer adam --lr 0.00005 -s $src -t $tgt --label-smoothing 0.1 \
...
--eval-bleu-print-samples False | tee -a $SAVEDIR/training.log > train.output &